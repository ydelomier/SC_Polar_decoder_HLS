...
#ifdef DEBUG_LIGHT
cout << "	+++++ [F_STATE]  N_value : " << (N<<1) << ", iteration : "<< N << ", adr_a : "<< adr_a << ", adr_b : "<< adr_b << ", w_a : "<< adr_w_a << ", w_b : "<< adr_w_b << endl;
#endif
...
#ifdef DEBUG_LIGHT
cout << "	----- [H_STATE]  N_value : " << N << ", iteration : "<< (N>>1) << ", ps_adr_a : " <<ps_adr_a << ", ps_adr_b : " <<ps_adr_b << endl;
#endif
					////
					h_loop: for( i = 0; i < (N>>1) ; i++)
					{
...
#ifdef DEBUG_LIGHT
cout << "	::::: [H0_STAT]  N_value : " << N << ", iteration : "<< (N>>1) << ", ps_adr_a : " <<ps_adr_a << ", ps_adr_b : " <<ps_adr_b << endl;
#endif
					////
					h0_loop: for( i = 0; i < (N>>1) ; i++)
					{
					#pragma HLS DEPENDENCE variable=bit_mem_1 array inter RAW false
					#pragma HLS DEPENDENCE variable=bit_mem_2 array inter RAW false
					#pragma HLS PIPELINE
...
cout << "					sb =  "; SHOW_BITS<PAR >(sb); cout << endl;
			...
			/**************************************************************/
				...
				F_R0_STATE :
				{
					...
					/////////////////////////////
#ifdef DEBUG_LIGHT
cout << "	===== [F_ELAG_] ( R0 ) N_value : " << N << ", iteration : "<< N << ", adr_a : "<< adr_a << ", adr_b : "<< adr_b << ", adr_s : "<< adr_s   <<  endl;
#endif

					f_pruned_R0: for( i = 0; i < N ; i++)
					{
					#pragma HLS DEPENDENCE variable=llr_mem_b array inter RAW false
					#pragma HLS DEPENDENCE variable=llr_mem_a array inter RAW false
					#pragma HLS PIPELINE
...
cout << "					ps =  "; SHOW_BITS<PAR>(ps); cout << endl;
			...
			/**************************************************************/
				...
				F_R1_STATE :
				{
					...
					/////////////////////////////
#ifdef DEBUG_LIGHT
cout << "	===== [F_ELAG_] ( R1 ) N_value : " << N << ", iteration : "<< v << ", adr_a : "<< adr_a << ", adr_b : "<< adr_b << ", adr_s : "<< adr_s   <<  endl;
#endif

					f_pruned_R1: for( i = 0; i < N ; i++)
					{
					#pragma HLS DEPENDENCE variable=llr_mem_b array inter RAW false
					#pragma HLS DEPENDENCE variable=llr_mem_a array inter RAW false
					#pragma HLS PIPELINE
...
cout << "					ps =  "; SHOW_BITS<PAR>(ps); cout << endl;
			...
			/**************************************************************/
				...
				F_REP_STATE :
				{
					...
					/////////////////////////////
#ifdef DEBUG_LIGHT
cout << "	===== [F_ELAG_] (REP ) N_value : " << N << ", iteration : "<< N << ", adr_a : "<< adr_a << ", adr_b : "<< adr_b << ", adr_s : "<< adr_s   <<  endl;
#endif
					sc_bigint< LLR_BITS + LOG2_PAR + 1 > sum = 0;
					f_pruned_REP: for( i = 0; i < N ; i++)
					{
					#pragma HLS DEPENDENCE variable=llr_mem_b array inter RAW false
					#pragma HLS DEPENDENCE variable=llr_mem_a array inter RAW false
					#pragma HLS PIPELINE
...
cout << "					ps =  "; SHOW_BITS<PAR>(ps); cout << endl;
			...
			/**************************************************************/
				...
				F_SPC_STATE :
				{
					...
					/////////////////////////////
#ifdef DEBUG_LIGHT
cout << "	===== [F_ELAG_] (SPC ) N_value : " << N << ", iteration : "<< N << ", adr_a : "<< adr_a << ", adr_b : "<< adr_b << ", adr_s : "<< adr_s   <<  endl;
#endif
