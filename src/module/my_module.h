...
cout << "					rs =  "; SHOW_LLRS<PAR, LLR_BITS >(result); cout << endl;
			...
			#if  ELAG_R1 == 1
									case NODE_R1 :
										next_state = G_R1_STATE; break;
			#endif
			#if  ELAG_SPC == 1
									case NODE_SPC :
										next_state = G_SPC_STATE; break;
			#endif
									default :
...
#else
							case NODE_R0 :
								next_state = F_R0_STATE; break;
#endif
	#if ELAG_RARE == 1
		#if  ELAG_R1 == 1
							case NODE_R1 :
								next_state = F_R1_STATE; break;
		#endif
		#if  ELAG_SPC == 1
							case NODE_SPC :
								next_state = F_SPC_STATE; break;
		#endif
	#endif
	#if  ELAG_REP == 1
							case NODE_REP :
								next_state = F_REP_STATE; break;
	#endif
							default :
					...
					if(R_State_condition == true){
						...
						switch(right_Node){
							...
							case NODE_R0 :
								...
								next_state = G_R0_STATE; break; // next state : Pruned G
		#if  ELAG_REP == 1
							case NODE_REP :
								G_stack_value = (sc_biguint<2>) 1;
								next_state = G_REP_STATE; break;
		#endif
	#endif
	#if  ELAG_R1 == 1
							case NODE_R1 :
